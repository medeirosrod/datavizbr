...
secao: praticas
descricao: Testando a página de post.
tags: [Dataviz, Share2016poa, Data Visualization,Porto Alegre]
---

Fui convidado para uma palestra no Share 2016 — Edição Porto Alegre. Falei sobre visualização de dados e técnicas de apresentação para profissionais de monitoramento e métricas. O nome da palestra foi Relatórios: Extreme Makeover, e a experiência foi bem legal.
...
Não é uma questão de poder usar, ou de gostar, é puro bom senso. Segundo Bertin, um cartógrafo francês que estudou os fundamentos da semiologia gráfica, e Edward Tufte, um dos pais da visualização de dados, o gráfico de pizza não funciona bem quando é usado para representar várias categorias.
