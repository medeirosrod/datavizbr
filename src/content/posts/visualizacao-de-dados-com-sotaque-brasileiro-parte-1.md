---
titulo: "Visualização de dados com sotaque brasileiro — parte 1"
autores:
  - rodrigo-medeiros
publicado_em: 2020-07-10
secao: panorama
...
Essa apresentação eu separei em seis partes:

- A primeira contando um pouco da história da infografia no Brasil;
- A segunda abordando a categorização que tenho feito, junto com a Júlia Giannella, desde 2015 sobre os tipos de trabalhos de visualização de dados no Brasil. E mostrando a primeira categoria de Arte (interfaces físicas);
- A terceira comenta sobre trabalhos de Design e Computação, relacionado também a Ciência de dados;
- A quarta comenta sobre alguns profissionais que trabalham com Jornalismo de dados;
- A quinta mostro um pouco sobre as interfaces cartográficas;
- E por fim, na última parte falamos sobre os grupos de pesquisa e comunidades que trabalham com visualização de dados no Brasil.

Nesse post vamos nos ater apenas a primeira parte dessa apresentação onde contamos a história da infografia no Brasil, onde eu tive uma excelente ajuda do amigo e professor de design da UFPE Ricardo Cunha Lima.

Fiz essa parte da apresentação porque temos uma rica história da infografia no país desde a década de 1990, bastante premiada e super respeitada mundo a fora. Provavelmente tivemos uma grande influência dessa geração de pesquisadores no nosso trabalho diário criando e analisando visualizações de dados.

Esses profissionais, além de excelentes na sua prática profissional, contribuíram muito para a comunidade formando uma geração de outros infografistas nas suas equipes.


Ary Moraes
O infografista trabalhou um tempo na Infoglobo e hoje é professor da Escola de Belas Artes / UFRJ. O Ary foi o primeiro brasileiro premiado com o Malofiej em 1996 com o infográfico sobre o Mike Tyson.

Em 2013 lançou o livro Infografia: História e Projeto e em 2015 o livro Design de Notícias: a Acessibilidade do Cotidiano, ambos pela editora Blucher.
