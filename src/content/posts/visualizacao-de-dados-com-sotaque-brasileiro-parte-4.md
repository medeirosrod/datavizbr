---
titulo: "Visualização de dados com sotaque brasileiro — parte 4"
autores:
  - rodrigo-medeiros
publicado_em: 2020-09-03
secao: panorama
serie: sotaque-brasileiro
ordem_na_serie: 4
tags:
  - dataviz
  - brasil
...
Reforçando o que disse na parte 2 dessa série, a categoria usada nessa série está em construção e muitos projetos e profissionais poderiam aparecer em mais de uma categoria. Minha escolha foi incluir os projetos na categoria que mais o representava, ou que possuía mais atributos. Reforço que a ordem apresentada no post não é um ranking mas a sequência que apresentei no Datavis Lisboa.

O jornalismo de dados é uma área do jornalismo que junta habilidades advindas de outras carreiras como estatística, geolocalização, cartografia, design e computação. Nessa lista contamos com pessoas que tiveram sua formação acadêmica e profissional no jornalismo e outras que, por essas outras habilidades, foram se aproximando. Designers, cientistas políticos, arquitetos, programadores, artistas 3D, vocês vão acompanhar uma variedade de projetos que ajuda a entender melhor o que estou tentando descrever por aqui.

Rodolfo Almeida

Rodolfo é jornalista, formado pela PUC-SP. E se descreve como data designer na Kunumi e jornalista visual na Núcleo Journalismo. O trabalho dele vai além e segue a linha para o design da informação, visualização de dados, cartografia e ilustração.

Rodolfo é um profissional super premiado. Ganhou o prêmio Cláudio Abramo Journalism Awards 2019, duas medalhas de bronze no Malofiej (2018 e 2019), duas medalhas de bronze da The Society for News Design (SND ÑH 2018 e 2019) e teve nomeação de melhor visualização no SIGMA Awards 2020 e em vários outros eventos.
...
![Ilustração e animação da reportagem do Núcleo Jornalismo sobre os alertas do IBAMA ao Ministério do Meio Ambiente](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/03.png)
...
Anteriormente fez parte do time da Questtonó, uma consultoria de inovação e liderou uma equipe que combinava dados, design e desenvolvimento web no Estadão. Ele também já ganhou alguns prêmios como Information is Beautiful Awards 2019 e 2017 na categoria Non-english e a medalha de bronze na categoria Digital — Formatos inovadores no #malofiej28, em 2020.

Vinicius participou da equipe que desenvolveu o projeto No Epicentro, da Agência Lupa e do Google News Initiative. Esse infográfico interativo sobre as mortes provocadas pela Covid-19 humaniza os dados simulando caso todos os mortes fossem “acumulados” na sua vizinhança. É o melhor projeto sobre a pandemia do Coronavírus no Brasil e possivelmente uma das melhores do mundo, vale muito a pena conferir na live que fizemos com a equipe ou no texto de making of que eles fizeram aqui no datavizbr.
...
![Simulação de crianças para adoção no Brasil visualizadas como plantas](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/04.gif)
...
Ele se descreve como um repórter que conta histórias com números. Rodrigo participou da equipe que desenvolveu a matéria “Gráficos mostram os temas dos discursos de posse desde a redemocratização” no Estadão. Essa matéria ganhou a medalha de prata na categoria Digital — Features no #malofiej28, em 2020. Ele também participou da equipe que desenvolveu o projeto No Epicentro, junto ao Vinicius Sueiro e ao Tiago Maranhão.

Become a Medium member
Em 2017, Menegat também ganhou o Information is Beautiful Awards, em parceria com o Vinicius Sueiro. E é sobre esse projeto que vamos comentar. Governo gasta fortunas com churrascos é uma matéria apurada e escrita por Rodrigo para o Lede Program, um curso da Escola de Jornalismo da Universidade de Columbia. Os dados e o código usado para análise estão disponíveis no GitHub. A explicação do gráfico deixo na descrição do próprio autor:
...
![Gráfico de gastos do governo em churrascos por Sueiro e Menegat](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/05.jpeg)
...
![Visualização “Na busca do Candidato” mostrando interesse de busca por candidatos presidenciais](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/06.jpeg)
...
Cecília é jornalista de dados. Já trabalhou no Estadão, atualmente trabalha na CNN Brasil.
...
![Mapa de roubos de celulares em São Paulo por Cecília Lago](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/07.gif)

Gabriel Zanlorenssi

Gabriel é graduado em Ciências Sociais pela USP e tem mestrado em Ciência Política pela mesma instituição. Atualmente é Cientista de Dados e Editor-assistente de Gráficos do Nexo Jornal.
...
![Linha do tempo da COVID-19 no Brasil por Gabriel Zanlorenssi e equipe Nexo](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/08.jpeg)
...
![Visualização do caminho dos impostos no Brasil por Simon Ducroquet](../../assets/blog/visualizacao-de-dados-com-sotaque-brasileiro-parte-4/09.png)
