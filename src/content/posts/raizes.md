...
Com base na definição anterior, foi iniciado o processo de determinar a elaboração das raízes. As primeiras ramificações foram feitas utilizando linhas curvas, porém não foi obtido um resultado satisfatório. Em um segundo momento, as linhas foram construídas com formas pontiagudas e geométricas, resultando em um direcionamento mais alinhado com a proposta do projeto.
