...
![Matriz de alinhamento com as hipóteses e o planejamento do projeto](../../assets/blog/raizes/03.png)
...
![Estrutura dos dados de denúncias monitorados pela central da Safernet](../../assets/blog/raizes/06.png)
...
![Referências visuais de visualizações com formas orgânicas](../../assets/blog/raizes/04.png)

*Fonte: Google Imagens*

![Referências visuais de raízes utilizadas como símbolo do projeto](../../assets/blog/raizes/05.png)
...
![Esboços iniciais do layout do projeto](../../assets/blog/raizes/07.jpeg)

![Estrutura numérica da relação Dados x Anos](../../assets/blog/raizes/08.png)
...
![Primeira proposta de ramificações com linhas curvas](../../assets/blog/raizes/09.png)
...
![Segunda proposta de ramificações com formas geométricas](../../assets/blog/raizes/10.png)

![Construção das ramificações superiores com aplicação de cores](../../assets/blog/raizes/11.png)

![Continuação da construção visual e refinamento estético](../../assets/blog/raizes/12.png)

![Desenvolvimento progressivo da visualização](../../assets/blog/raizes/13.png)

**DataViz**

![Guia de estilo completo do projeto Raízes](../../assets/blog/raizes/14.gif)
